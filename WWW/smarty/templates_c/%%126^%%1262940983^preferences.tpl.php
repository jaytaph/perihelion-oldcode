<?php /* Smarty version 2.6.2, created on 2004-06-03 18:14:36
         compiled from /home/joshua/WWW/themes/SimplyRed/preferences.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'comment', '/home/joshua/WWW/themes/SimplyRed/preferences.tpl', 3, false),array('function', 'validate', '/home/joshua/WWW/themes/SimplyRed/preferences.tpl', 20, false),array('function', 'html_select_date', '/home/joshua/WWW/themes/SimplyRed/preferences.tpl', 57, false),array('function', 'html_options', '/home/joshua/WWW/themes/SimplyRed/preferences.tpl', 102, false),array('modifier', 'default', '/home/joshua/WWW/themes/SimplyRed/preferences.tpl', 23, false),)), $this); ?>
<!-- preferences-form -->
...
<table class='standard' align='center'>
  ...
  <?php echo smarty_function_validate(array('field' => 'name','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><b><li>Name cannot be empty</b></td></tr>'), $this);?>
...
' size='30' maxlength='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'email','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><b><li>Your email address cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'email','criteria' => 'isEmail','message' => '<tr ><td colspan="2"><b><li>Email should be a valid email address</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'email','criteria' => 'isCustom','function' => 'validate_email_is_ours_or_does_not_exists','message' => '<tr ><td colspan="2"><b><li>Email address is already registered</b></td></tr>'), $this);?>
...
' size='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'city','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><b><li>Your city cannot be empty</b></td></tr>'), $this);?>
...
' size='30' maxlength='50'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'country','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><b><li>Your country cannot be empty</b></td></tr>'), $this);?>
...
' size='30' maxlength='30'></td>
  ...
  <?php endif; ?>
  <?php echo smarty_function_validate(array('field' => 'login_pass1','criteria' => 'isEqual','field2' => 'login_pass2','message' => '<tr  colspan="2"><td><b><li>Your passwords do not match</b></td></tr>'), $this);?>
...
" size='30' maxlength='200'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'current_pass','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><b><li>Your current password cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'current_pass','criteria' => 'isCustom','function' => 'validate_passwd','message' => '<tr  colspan="2"><td><b><li>Invalid password.</b></td></tr>'), $this);?>
