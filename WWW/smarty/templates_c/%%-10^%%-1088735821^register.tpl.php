<?php /* Smarty version 2.6.2, created on 2004-06-03 14:02:18
         compiled from /home/joshua/WWW/themes/Simple/register.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'comment', '/home/joshua/WWW/themes/Simple/register.tpl', 3, false),array('function', 'validate', '/home/joshua/WWW/themes/Simple/register.tpl', 24, false),array('function', 'html_select_date', '/home/joshua/WWW/themes/Simple/register.tpl', 74, false),array('function', 'html_options', '/home/joshua/WWW/themes/Simple/register.tpl', 137, false),array('modifier', 'default', '/home/joshua/WWW/themes/Simple/register.tpl', 40, false),)), $this); ?>
<!-- register-form -->
...
<table class='standard' align='center'>
  ...
  <?php echo smarty_function_validate(array('field' => 'name','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><li><b>Name cannot be empty</b></td></tr>'), $this);?>
...
' size='30' maxlength='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'email','criteria' => 'notEmpty','message' => '<tr><td colspan="2"><li><b>Your email address cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'email','criteria' => 'isEmail','message' => '<tr><td colspan="2"><li><b>Email should be a valid email address</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'email','criteria' => 'isCustom','function' => 'validate_email','message' => '<tr ><td colspan="2"><li><b>Email address is already registered</b></td></tr>'), $this);?>
...
' size='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'city','criteria' => 'notEmpty','message' => '<tr><td colspan="2"><li><b>Your city cannot be empty</b></td></tr>'), $this);?>
...
' size='30' maxlength='50'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'country','criteria' => 'notEmpty','message' => '<tr><td colspan="2"><li><b>Your country cannot be empty</b></td></tr>'), $this);?>
...
' size='30' maxlength='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'login_name','criteria' => 'notEmpty','message' => '<tr><td colspan="2"><li><b>Your login name cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'login_name','criteria' => 'isCustom','function' => 'validate_login','message' => '<tr ><td colspan="2"><li><b>Login name is already registered</b></td></tr>'), $this);?>
...
' size='30' maxlength='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'login_pass1','criteria' => 'notEmpty','message' => '<tr colspan="2"><td><b>aaYour password cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'login_pass1','criteria' => 'isEqual','field2' => 'login_pass2','message' => '<tr  colspan="2"><td><li><b>Your passwords do not match</b></td></tr>'), $this);?>
...
' size='30' maxlength='200'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'specie_name','criteria' => 'notEmpty','message' => '<tr ><td colspan="2" colspan="2"><li><b>Your specie name cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'specie_name','criteria' => 'isCustom','function' => 'validate_specie','message' => '<tr ><td colspan="2"><li><b>Specie name is already registered</b></td></tr>'), $this);?>
...
' size='30' maxlength='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'sector_name','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><li><b>Your sector name cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'sector_name','criteria' => 'isCustom','function' => 'validate_sector','message' => '<tr ><td colspan="2"><li><b>Sector name is already registered</b></td></tr>'), $this);?>
...
' size='30' maxlength='30'></td>
  ...
  <?php echo smarty_function_validate(array('field' => 'planet_name','criteria' => 'notEmpty','message' => '<tr ><td colspan="2"><li><b>Your planet name cannot be empty</b></td></tr>'), $this);?>

  <?php echo smarty_function_validate(array('field' => 'planet_name','criteria' => 'isCustom','function' => 'validate_planet','message' => '<tr ><td colspan="2"><li><b>Planet name is already registered</b></td></tr>'), $this);?>
