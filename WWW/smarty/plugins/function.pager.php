  ...
  */
  function smarty_function_pager($params, &$smarty)
  {
      ...
      */
      ...
      if (! isset ($_REQUEST[$posvar])) $_REQUEST[$posvar] = 0;
      ...
      if (($pos == 0)    AND ((!empty($txt_first)) OR !empty($img_first))){
          ...
          // START PRININT
          if ($txt_pos == 'top') {
              print '<p 2 align="center">'.$cache['prev'].$cache['next'].'</p>'."\n";
          }
          print '<p 3 align="center">'.$pre_tag;          
          ...
          if ($txt_pos == 'bottom') {
              print '<p 4 align="center">'.$cache['prev'].$cache['next'].'</p>'."\n";
          }
