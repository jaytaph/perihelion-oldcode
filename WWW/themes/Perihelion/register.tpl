...
<table class='standard' align='center'>
  ...
  {validate field='email' criteria='isCustom' function='validate_email' message='<tr class="false"><td colspan="2"><li>Email address is already registered</td></tr>'}
  <tr>   
  ...
  {validate field='login_name' criteria='notEmpty' message='<tr class="false"><td colspan="2"><li>Your login name cannot be empty</td></tr>'}
  {validate field='login_name' criteria='isCustom' function='validate_login' message='<tr class="false"><td colspan="2"><li>Login name is already registered</td></tr>'}
  <tr>   
    <td>&nbsp;Login name:</td>
    <td><input type='text' name='login_name' value='{$login_name|default}' size='30' maxlength='30'></td>
  </tr>  
  {validate field='login_pass1' criteria='notEmpty' message='<tr class="false" colspan="2"><td><li>Your password cannot be empty</td></tr>'}
  ...
  {validate field='specie_name' criteria='notEmpty' message='<tr class="false"><td colspan="2" colspan="2"><li>Your specie name cannot be empty</td></tr>'}
  {validate field='specie_name' criteria='isCustom' function='validate_specie' message='<tr class="false"><td colspan="2"><li>Specie name is already registered</td></tr>'}
  <tr>   
  ...
  {validate field='sector_name' criteria='notEmpty' message='<tr class="false"><td colspan="2"><li>Your sector name cannot be empty</td></tr>'}
  {validate field='sector_name' criteria='isCustom' function='validate_sector' message='<tr class="false"><td colspan="2"><li>Sector name is already registered</td></tr>'}
  <tr>   
  ...
  {validate field='planet_name' criteria='notEmpty' message='<tr class="false"><td colspan="2"><li>Your planet name cannot be empty</td></tr>'}
  {validate field='planet_name' criteria='isCustom' function='validate_planet' message='<tr class="false"><td colspan="2"><li>Planet name is already registered</td></tr>'}
  <tr>   
