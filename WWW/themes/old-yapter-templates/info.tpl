<!-- info -->
  ...
  <table class="standard" align=center width=60%>
    ...
    <tr><td>&nbsp;Heartbeat server:&nbsp;</td>      <td>&nbsp;<font color={heartbeat_status_color}>{heartbeat_status}</font>&nbsp;</td></tr>
  [BLOCK block_heartbeat]
  ...
  [END block_heartbeat]    
    <tr><td>&nbsp;Communication server:&nbsp;</td>  <td>&nbsp;<font color={commserver_status_color}>{commserver_status}</font>&nbsp;</td></tr>    
  [BLOCK block_commserver]
    ...
    <tr><td colspan=2>&nbsp;</td></tr>
  [END block_commserver]  
    <tr><td>&nbsp;MySQL server:&nbsp;</td>          <td>&nbsp;<font color={mysql_status_color}>{mysql_status}</font>&nbsp;</td></tr>
  [BLOCK block_mysql]
