...
<table class='standard' align='center'>
  ...
  {validate field='name' criteria='notEmpty' message='<tr ><td colspan="2"><b><li>Name cannot be empty</b></td></tr>'}
  <tr>        
    <td>&nbsp;Name:</td>
    <td><input type='text' name='name' value='{$name|default}' size='30' maxlength='30'></td>
  </tr>
  {validate field='email' criteria='notEmpty' message='<tr ><td colspan="2"><b><li>Your email address cannot be empty</b></td></tr>'}
  {validate field='email' criteria='isEmail'  message='<tr ><td colspan="2"><b><li>Email should be a valid email address</b></td></tr>'}
  {validate field='email' criteria='isCustom' function='validate_email_is_ours_or_does_not_exists' message='<tr ><td colspan="2"><b><li>Email address is already registered</b></td></tr>'}
  <tr>   
    <td>&nbsp;Email:</td>
  ...
  {validate field='city' criteria='notEmpty' message='<tr ><td colspan="2"><b><li>Your city cannot be empty</b></td></tr>'}
  <tr>   
    <td>&nbsp;City:</td>
    <td><input type='text' name='city' value='{$city|default}' size='30' maxlength='50'></td>
  </tr>
  
  {validate field='country' criteria='notEmpty' message='<tr ><td colspan="2"><b><li>Your country cannot be empty</b></td></tr>'}
  <tr>   
    <td>&nbsp;Country:</td>
  ...
  {/if}
  {validate field='login_pass1' criteria='isEqual' field2='login_pass2' message='<tr  colspan="2"><td><b><li>Your passwords do not match</b></td></tr>'}
  <tr>   
    <td>&nbsp;Password:</td>
  ...
  {validate field='current_pass' criteria='notEmpty' message='<tr ><td colspan="2"><b><li>Your current password cannot be empty</b></td></tr>'}
  {validate field='current_pass' criteria='isCustom' function='validate_passwd' message='<tr  colspan="2"><td><b><li>Invalid password.</b></td></tr>'}
  <tr>   
